...
/////////////////
const BotName = 'RAKHA BOT☄'; 
const instagram = 'https://instagram.com/gue.rakha07'; 
const telegram = 'https://t.me/rakha'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCNstGvlhN-FBF8uJu95nhQw';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@gue.rakha07')
